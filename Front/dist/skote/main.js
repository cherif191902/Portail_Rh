...
class TokenStorage {
    ...
    getUser() {
        ...
        if (user) {
            ...
            return Object.assign(Object.assign({}, userData), { matriculeP: userData.matricule || userData.email, role_portail: mappedRoles.length > 0 ? mappedRoles[0] : 'ROLE_USER', roles: mappedRoles // Rôles mappés en format string
             });
        }
        return {};
    }
